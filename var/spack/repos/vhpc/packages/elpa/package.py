...
class Elpa(AutotoolsPackage):
    ...
    version('2019.05.001',
            sha256='772c03dab8713ba3891b17757a0b8429b3c4bec4b261dd337ed4b34311f6b221')
    version('2018.11.001',
    ...
    variant('avx2', default=False, description='Build avx2 kernels')
    ...
    def configure_args(self):
        ...
        options.append('--{0}-avx2'.format(
            'enable' if '+avx2' in spec else 'disable')
            )
